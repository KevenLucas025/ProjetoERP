...
#*******************************************************************************************************
    def editar_produto(self):
        if self.table_widget.currentRow() >= 0:
            ...
            for frame in [self.main_window.frame_valor_total_produtos, 
                      self.main_window.frame_valor_desconto, 
                      self.main_window.frame_quantidade, 
                      self.main_window.frame_valor_do_desconto]:
                if frame.layout():
            ...
            # Criar labels para os valores
            label_valor_total = QLabel(f"R$ {valor_total:.2f}")
            label_valor_desconto = QLabel(f"R$ {valor_do_desconto:.2f}")
            label_quantidade = QLabel(str(produto_quantidade))
            label_valor_com_desconto = QLabel(f"R$ {valor_com_desconto:.2f}")


            # Ajustar o alinhamento dos labels
            for label in [label_valor_total, label_valor_desconto, label_quantidade, label_valor_com_desconto]:
                label.setAlignment(Qt.AlignCenter)

            # Criar um layout vertical para cada frame de valor e adicionar o label correspondente
            for frame, label in zip([self.main_window.frame_valor_total_produtos,
                                    self.main_window.frame_valor_desconto,
                                    self.main_window.frame_quantidade,
                                    self.main_window.frame_valor_do_desconto],
                                    [label_valor_total, label_valor_desconto, label_quantidade, label_valor_com_desconto]):
                layout = QVBoxLayout()
            ...
            for frame in [self.main_window.frame_valor_total_produtos,
                        ...
                        self.main_window.frame_quantidade,
                        self.main_window.frame_valor_do_desconto]:
                frame.setGeometry(125, 28, largura, altura)
                frame.setMaximumWidth(largura)
