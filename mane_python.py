...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.frame_pg_clientes.sizePolicy().hasHeightForWidth())
        self.frame_pg_clientes.setSizePolicy(sizePolicy)
        ...
        self.line_clientes.setStyleSheet(u"")
        ...
        self.line_clientes_fisicos.setStyleSheet(u"")
        ...
        sizePolicy.setHeightForWidth(self.frame_pg_contato.sizePolicy().hasHeightForWidth())
        self.frame_pg_contato.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_17 = QGridLayout(self.frame_desenvolvido)
        ...
        self.gridLayout_17.addWidget(self.label_desenvolvido, 0, 0, 1, 3)

        self.label_icone_wpp = QLabel(self.frame_desenvolvido)
        self.label_icone_wpp.setObjectName(u"label_icone_wpp")
        sizePolicy.setHeightForWidth(self.label_icone_wpp.sizePolicy().hasHeightForWidth())
        self.label_icone_wpp.setSizePolicy(sizePolicy)
        self.label_icone_wpp.setMaximumSize(QSize(40, 40))
        self.label_icone_wpp.setFrameShape(QFrame.NoFrame)
        self.label_icone_wpp.setPixmap(QPixmap(u"../../../../Downloads/whatsapp.png"))
        self.label_icone_wpp.setScaledContents(True)

        self.gridLayout_17.addWidget(self.label_icone_wpp, 1, 0, 1, 2)

        self.label_wpp_contato = QLabel(self.frame_desenvolvido)
        self.label_wpp_contato.setObjectName(u"label_wpp_contato")
        sizePolicy.setHeightForWidth(self.label_wpp_contato.sizePolicy().hasHeightForWidth())
        self.label_wpp_contato.setSizePolicy(sizePolicy)
        self.label_wpp_contato.setFrameShape(QFrame.NoFrame)

        self.gridLayout_17.addWidget(self.label_wpp_contato, 1, 2, 1, 1)

        self.label_icone_email = QLabel(self.frame_desenvolvido)
        self.label_icone_email.setObjectName(u"label_icone_email")
        sizePolicy.setHeightForWidth(self.label_icone_email.sizePolicy().hasHeightForWidth())
        self.label_icone_email.setSizePolicy(sizePolicy)
        self.label_icone_email.setMaximumSize(QSize(40, 40))
        self.label_icone_email.setFrameShape(QFrame.NoFrame)
        self.label_icone_email.setPixmap(QPixmap(u"../../../../Downloads/e-mail.png"))
        self.label_icone_email.setScaledContents(True)

        self.gridLayout_17.addWidget(self.label_icone_email, 2, 0, 1, 1)

        self.label_email_contato = QLabel(self.frame_desenvolvido)
        self.label_email_contato.setObjectName(u"label_email_contato")
        sizePolicy.setHeightForWidth(self.label_email_contato.sizePolicy().hasHeightForWidth())
        self.label_email_contato.setSizePolicy(sizePolicy)
        self.label_email_contato.setFrameShape(QFrame.NoFrame)

        self.gridLayout_17.addWidget(self.label_email_contato, 2, 1, 1, 2)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_desenvolvido.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600;\">Desenvolvido  por:</span></p><p align=\"center\"><span style=\" font-size:16pt; font-weight:600;\">Keven Lucas</span></p><p align=\"center\"><span style=\" font-style:italic;\"><br/></span></p></body></html>", None))
        self.label_icone_wpp.setText("")
        self.label_wpp_contato.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:600;\">(19) 98201-8869</span></p></body></html>", None))
        self.label_icone_email.setText("")
        self.label_email_contato.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:600;\">keven.lucas00@hotmail.com</span></p></body></html>", None))
