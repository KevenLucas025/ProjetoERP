...
class Ui_Login(object):
    def setupUi(self, Login):
        ...
        self.btn_manter_conectado = QCheckBox(self.frame)
        self.btn_manter_conectado.setObjectName(u"btn_manter_conectado")
        self.btn_manter_conectado.setEnabled(True)
        self.btn_manter_conectado.setGeometry(QRect(130, 150, 161, 41))
...
"")
        ...
        self.label_trocar_senha = QLabel(self.frame)
        self.label_trocar_senha.setObjectName(u"label_trocar_senha")
        self.label_trocar_senha.setGeometry(QRect(160, 190, 81, 16))
        ...
        self.label_primeiro_acesso = QLabel(self.frame)
        self.label_primeiro_acesso.setObjectName(u"label_primeiro_acesso")
        self.label_primeiro_acesso.setGeometry(QRect(160, 130, 81, 20))
        ...
        self.label.setPixmap(QPixmap(u"../../../Downloads/homem-usuario.png"))
    ...
    def retranslateUi(self, Login):
        ...
        self.btn_manter_conectado.setText(QCoreApplication.translate("Login", u"Mantenha-me conectado", None))
        self.btn_login.setText(QCoreApplication.translate("Login", u"Login", None))
        self.label_primeiro_acesso.setText(QCoreApplication.translate("Login", u"Primeiro acesso?", None))
        self.label.setText("")
    # retranslateUi
