...
=======
    def selecionar_todos_users(self):
        ...
        # Se estiver desmarcando E todos os checkboxes estiverem desmarcados, remova a coluna
        if estado == Qt.Unchecked and all(not cb.isChecked() for cb in self.checkboxes):
            self.selecionar_users_individual()  # Reaproveita a função de remover a coluna
            return
